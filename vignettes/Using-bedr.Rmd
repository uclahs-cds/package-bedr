...
In this example, we show bedr can be used to annotate copy number segmented (regions) data with gene identifiers. The copy-number data is a subset of TCGA COAD dataset. Next we will demonstrate how to... The example will be limited to data on chromosome 1 and 2 only.
