...
* sort.region & is.sorted.region
* merge.region & is.merged.region
* in.region & order.region
* subtract.region
* flank.region & grow.region
* intersectRegion
* join.region & join.multiple.region
* get.RegionSize
* get.fastaRegion
* jaccard & reldist
...
a.sub2 <- subtract.region(a.merge1, b.merge1);
