...
order_region <- function(x, method = "lex", check.zero.based = TRUE, check.chr = TRUE, check.valid = TRUE, check.merge = TRUE) {
	...
	x <- sort_region(x, method = method,check.zero.based = check.zero.based, check.chr = check.chr, check.valid = FALSE, check.merge = FALSE, verbose = FALSE);
